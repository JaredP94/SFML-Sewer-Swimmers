...
TEST(EntityContainer, canAddMultipleEntitiesUsingAddEntityFunctionality)
{
	...
	shared_ptr<Player> player_ptr_1 = make_shared<Player> ();
	shared_ptr<Player> player_ptr_2 = make_shared<Player> ();
	
	test_entity.addEntity(player_ptr_1);
	test_entity.addEntity(player_ptr_2);
...
TEST(EntityContainer, canDeleteAnEntityAtRandomPositionUsingRemoveEntityFunctionality)
{
	...
	shared_ptr<Player> player_ptr_1 = make_shared<Player> ();
	shared_ptr<Player> player_ptr_2 = make_shared<Player> ();
	shared_ptr<Player> player_ptr_3 = make_shared<Player> ();
	
	test_entity.addEntity(player_ptr_1);
	test_entity.addEntity(player_ptr_2);
	test_entity.addEntity(player_ptr_3);
